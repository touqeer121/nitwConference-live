# Generated by Django 3.2 on 2021-06-11 20:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remark_A', models.CharField(blank=True, default='', max_length=500)),
                ('remark_B', models.CharField(blank=True, default='', max_length=500)),
                ('track_A', models.CharField(blank=True, default='A', max_length=500, null=True)),
                ('track_B', models.CharField(blank=True, default='admin', max_length=500, null=True)),
                ('country', models.CharField(blank=True, default='undefined', max_length=500, null=True)),
